...
Copy the block below. If it runs over 15 rows, save it to `records/timelines/YYYY-MM-DD-SLUG.md`
in the kit; otherwise, summarize it in the entry's Observed line.
...
- `SOURCE`: where the event came from: `activity c3d4`, `git log abc123`, `reflog`,
  `NOTEBOOK 2026-08-28`, `records/directives/2026-08-25-sdk.md`, or `unknown`.
