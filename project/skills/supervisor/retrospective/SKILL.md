...
1. **Collect evidence, not memory.** Read the period's attention logs under `.seatworks/records/attention/` and lesson lines under `.seatworks/records/lessons/`, and quote each line you use with its date; a retrospective from memory reproduces what you already believed.
