...
relative to this skill's directory, except paths starting with `.seatworks/`, which are relative to the repository root. You send the directive to a Lead and keep a
copy at `.seatworks/records/directives/YYYY-MM-DD-SLUG.md`: a retrospective later needs the exact text
...
2. Save the directive to `.seatworks/records/directives/YYYY-MM-DD-SLUG.md`. **Done** when the file
   exists.
