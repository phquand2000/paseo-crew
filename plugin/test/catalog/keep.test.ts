...
const KEEP: Keep[] = [
  ...
  { id: "refuted-1", title: "one writer at a time in a shared working copy", file: "server/desk/tasks/placement.ts", check: "contains", anchor: "is still writing in the lane's working copy, and it holds one writer at a time." },
  { id: "refuted-2", title: "a lane never takes over a dirty working copy", file: "server/desk/own-copy.ts", check: "contains", anchor: "the project's own working copy has uncommitted changes, so a lane cannot take it over" },
