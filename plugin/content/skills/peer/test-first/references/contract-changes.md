...
1. **Update every consumer in the same commit.** Find every shipping producer, consumer and generated artifact with the contract search on the old name, regenerate generated files with the repository's generator, and `ask` about any outside your owned paths. One left on the old shape breaks at runtime.
