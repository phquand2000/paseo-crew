...
4. **Compare every slice.** What demonstrated requirement forces each mechanism? Does cost follow useful work? Are the normal and exceptional paths reversed? What is lost by removing or moving it? Use `$PASEO_CREW_KIT/content/guides/STRUCTURAL_LENSES.md` as search lenses; its domain examples show the detail an expected mechanism needs.
