...
| Work moving | HANDBACK, REWORK, AMENDED, BESIDE, MERGED, MERGE WAITS, MERGE FAILED, MERGE CONFLICT, BASE CONFLICT, REPORT, CAN LAND, CLEARED |
...
RECONCILE tells a Lead what the Supervisor sent its Peer. BESIDE tells the Peer at work in the lane's copy that a task started beside it after its brief was written, and what that task holds; a Peer that has handed back reads it with its next letter. HUMAN WROTE tells whoever supervises what the Human
