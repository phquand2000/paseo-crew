...
RECONCILE tells a Lead what the Supervisor sent its Peer. BESIDE tells the Peer at work in the lane's copy that a task started beside it after its brief was written, and what that task holds; a Peer that has handed back reads it with its next letter. SETTLING tells a Lead in passing that bringing its lane into a task's branch at hand-back stopped on conflicts, which that task's Peer settles before it hands back. HUMAN WROTE tells whoever supervises what the Human
